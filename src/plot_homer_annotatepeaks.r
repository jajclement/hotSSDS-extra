...
for (idx in 1:length(HomerFiles)) {
    ...
    unique.gene.dat <- unique.gene.dat[unique.gene.dat$Nearest.PromoterID, ] #pauline auffret 2021-11-30
...
plot  <- ggplot(plot.feature.dat, aes(x=variable, y=value, group=feature)) +
	 ...
	 theme(plot.title = element_text(size = 8, face = "bold")) + #pauline auffret 2021-11-30
